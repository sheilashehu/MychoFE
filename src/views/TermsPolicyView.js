...
class TermsPolicyView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/TermsPolicyController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '62584f2b027b0a77090719e6'
  ...
  render() {
    const proxies = TermsPolicyView.Controller !== TermsPolicyView ? transformProxies(this.props.children) : {
        ...
        <span className="af-view">
          <div className="af-class-body-5">
              ...
              <div className="af-class-nav-links">
                <div data-hover="false" data-delay={200} className="af-class-dropdown w-dropdown">
                  ...
                  <nav className="af-class-dropdown-list w-dropdown-list">
                    ...
                    <a href="terms-policy.html" aria-current="page" className="af-class-dropdown-link w-dropdown-link w--current">policy</a>
                  </nav>
                </div>
                <div data-hover="false" data-delay={200} className="af-class-dropdown w-dropdown">
                  <div className="af-class-dropdown-toggle w-dropdown-toggle">
            ...
            <div className="af-class-wf-section">
              <h1 className="af-class-heading-3">Terms &amp; Policy</h1>
            </div>
            <div />
